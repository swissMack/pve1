...
/**
 * Proxy endpoint for Analytics API: GET /analytics/unique/imsi/count/tenant/network
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const analyticsUrl = `${ANALYTICS_API_URL}/analytics/unique/imsi/count/tenant/network?${queryParams}`
