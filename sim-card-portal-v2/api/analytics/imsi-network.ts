...
/**
 * Proxy endpoint for Analytics API: GET /analytics/imsi/network
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    const { period, periodEnd, imsi, mccmnc, customer, tenant } = req.query
    ...
    const analyticsUrl = `${ANALYTICS_API_URL}/analytics/imsi/network?${queryParams}`
