...
import type { ConsumptionKpi } from '@/types/kpi'

defineProps<{
  kpis: ConsumptionKpi | null
  loading: boolean
}>()
        ...
        <Card class="h-full">
          <template #content>
            <div class="text-center">
              ...
              <template v-else-if="kpis">
                <div class="text-2xl font-bold text-900">{{ kpis.dataUsageGB.toFixed(1) }} GB</div>
        ...
        <Card class="h-full">
          <template #content>
            <div class="text-center">
              ...
              <template v-else-if="kpis">
                <div class="text-2xl font-bold text-900">{{ kpis.activeSims.toLocaleString() }}</div>
