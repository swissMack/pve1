...
const props = defineProps({
  ...
  iccidSearch: { type: String, default: '' }
})

const emit = defineEmits(['update:statusFilter', 'update:iccidSearch', 'select', 'reset-filters'])
  ...
  <div class="sim-list">
    <div class="flex gap-3 mb-4 align-items-center">
      ...
      <InputText
        ...
        @update:modelValue="emit('update:iccidSearch', $event)"
